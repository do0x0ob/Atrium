...
/**
 * RetroWindow - A retro-styled window component with white theme
 * 
 * Features:
 * - Beveled 3D edges matching RetroSelect style
 * - White background with subtle gradients
 * - Draggable title bar with close button (desktop only)
 * - Optional resize handle (desktop only)
...
export const RetroWindow: React.FC<RetroWindowProps> = ({
  ...
  // Check if the window is on mobile
  useEffect(() => {
    const checkMobile = () => {
